...
После того как контейнеры будут запущены, используйте
 команду create_superuser для создания суперпользователя:
***Примечание:*** Замените <имя_контейнера_backend> на реальное имя
...
```
***В процессе выполнения вас попросят ввести следующие данные:***
...
***Проверьте, что суперпользователь создан:***
